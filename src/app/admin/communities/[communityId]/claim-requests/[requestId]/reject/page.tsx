    ...
    if (error === 'unauthorized') {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6">
                ...
                <p className="text-slate-500">You must be a community admin to reject claims.</p>
    ...
    return (
        <div className="max-w-5xl mx-auto p-6 space-y-8">
            ...
            <div className="flex items-center gap-4 mb-8">
                <button 
                    onClick={() => router.push(`/admin/communities/${communityId}/claim-requests/${requestId}/approve`)} 
                ...
                <div>
                    ...
                    <p className="text-slate-500 font-bold uppercase tracking-widest text-xs mt-1">
                        Community Admin - Review and reject player profile claim
                    </p>
                </div>
            </div>
