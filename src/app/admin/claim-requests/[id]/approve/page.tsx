        ...
        <div className="max-w-5xl mx-auto p-6 space-y-8">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-slate-500 font-bold uppercase tracking-widest text-xs mt-1">
                        World Admin - Review and approve player profile claim
                    </p>
                </div>
            </div>
            ...
            <div className="bg-input border border-border rounded-2xl overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                    ...
                    {claim.community && (
                        <div className="bg-card border border-border rounded-xl p-4">
                            <h3 className="text-sm font-bold uppercase tracking-widest text-slate-500 mb-4">Community</h3>
                            <div className="font-bold">{claim.community.name}</div>
                            <div className="text-xs text-slate-500 mt-1">ID: {claim.community.id}</div>
                        </div>
                    )}
            ...
            <div className="flex gap-4">
                ...
                <button
                    onClick={() => router.push(`/admin/claim-requests/${requestId}/reject`)}
