...
describe('Tournament Teams API Route', () => {
    ...
    describe('GET', () => {
        it('should return teams in tournament', async () => {
            ...
            (db.query.tournamentTeams.findMany as any).mockReturnValue(mockTeams);
        ...
        it('should return 500 on database error', async () => {
            (db.query.tournamentTeams.findMany as any).mockRejectedValue(new Error('DB error'));
    ...
    describe('POST', () => {
        it('should add team to tournament', async () => {
            ...
            (db.query.tournamentTeams.findFirst as any).mockReturnValue(null);
        ...
        it('should return 400 if team already in tournament', async () => {
            ...
            (db.query.tournamentTeams.findFirst as any).mockReturnValue({ id: '1', teamId: 'team_1' });
