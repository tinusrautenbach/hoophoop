            ...
            <AnimatePresence>
                {editingEvent && (
                    <motion.div
                        ...
                        className="fixed inset-0 z-[110] bg-background/95 backdrop-blur-xl p-6 flex flex-col items-center justify-center"
                    >
                        <div className="w-full max-w-lg bg-input border border-border rounded-3xl p-6 shadow-2xl">
                                                ...
                                                onClick={() => setEditingEvent({ ...editingEvent!, value: v })}
                                                    className={cn(
                                                        ...
                                                        editingEvent.value === v
                                                            ...
                                                            : "bg-card border-border text-slate-500 hover:border-slate-500"
                                                    )}
                                                >
                                                    {v}
                                                </button>
